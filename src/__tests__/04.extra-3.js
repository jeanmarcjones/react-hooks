...
test('can play a game of tic tac toe', async () => {
  ...
  alfredTip(
    ...
    'a Make sure that the localStorage item is updated with the JSON.stringified squares array',
  );
  ...
  alfredTip(
    ...
    'b Make sure that the localStorage item is updated with the JSON.stringified squares array',
  );
});
